...
# "/data/cxy/LMEye/playground/data/eval/vqav2/answers_upload/llava_vqav2_mscoco_val/lmeye-7b-baseline-1.5epoch-1epoch.json"
resFile = "llava_vqav2_mscoco_val.json"
