...
cvlm_path = os.path.join(project_root, "CVLM")
if cvlm_path not in sys.path:
    sys.path.insert(0, cvlm_path)
...
class CustomDataset(Dataset):
    def __init__(self, questions, image_folder, tokenizer, image_processor, model_config):
        ...
        self.opt_tokenizer = transformers.AutoTokenizer.from_pretrained("CVLM/facebook/opt-1.3b", add_bos_token=True)
...
def eval_model(args):
    ...
    qformer_tokenizer = transformers.AutoTokenizer.from_pretrained(
        "CVLM/local_models/qformer_tokenizer")
    disable_torch_init()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="CVLM/checkpoints/CVLM-LLaVA/checkpoint-1epoch")
    parser.add_argument("--model-base", type=str, default="CVLM/lmsys/vicuna-7b-v1.5")
    parser.add_argument("--image-folder", type=str, default="")
    parser.add_argument("--question-file", type=str, default="tw_dataset/twitter_dataset/devset/CVLM_questions.jsonl")
    parser.add_argument("--answers-file", type=str, default="tw_dataset/twitter_dataset/devset/CVLM_answers.jsonl")
    parser.add_argument("--conv-mode", type=str, default="vicuna_v1")
    parser.add_argument("--num-chunks", type=int, default=1)
    parser.add_argument("--chunk-idx", type=int, default=0)
    parser.add_argument("--temperature", type=float, default=0)
    parser.add_argument("--sam_image_folder", type=str, default="CVLM/playground/knowledge_qa/sam/images_all")
